% qt6-tools(SECTION) | User Commands
%
% "November 18 2021"
...
qt6-tools - program to do something

# SYNOPSIS

**qt6-tools** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**qt6-tools** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **qt6-tools** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**qt6-tools** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    qt6-tools. See **foo.conf**(5) for further details.
...
**qt6-tools** provides some return codes, that can be used in scripts:
